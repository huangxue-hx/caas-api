...
INSERT INTO `resource_menu_role` (`weight`,`create_time`,`update_time`,`available`,`role_id`,`rmid`)
VALUES (33,'2019-01-14 17:28:00','2019-01-14 17:28:00',1,1,33);

INSERT INTO `resource_menu` (`id`,`name`,`name_en`,`type`,`url`,`weight`,`create_time`,`update_time`,`available`,`icon_name`,`isparent`,`parent_rmid`,`module`)
VALUES (34,'监控中心','Monitor Center','menu','monitorCenter',34,'2019-02-14 16:47:00','2019-02-14 16:50:56',1,'menu-icon mi-storage',1,0,'monitorcenter');

INSERT INTO `resource_menu_role` (`weight`,`create_time`,`update_time`,`available`,`role_id`,`rmid`)
VALUES (34,'2019-01-14 17:28:00','2019-01-14 17:28:00',1,1,34);

INSERT INTO `resource_menu_role` (`weight`,`create_time`,`update_time`,`available`,`role_id`,`rmid`)
VALUES (34,'2019-01-14 17:28:00','2019-01-14 17:28:00',1,2,34);
