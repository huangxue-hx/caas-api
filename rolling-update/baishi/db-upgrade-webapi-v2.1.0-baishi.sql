...
INSERT INTO `k8s_auth_server`.`resource_menu_role` (`weight`, `create_time`, `update_time`, `available`, `role_id`, `rmid`)
VALUES ('41', '2019-01-14 17:28:00', '2019-01-14 17:28:00', '1', '2', '41');

INSERT INTO `k8s_auth_server`.`resource_menu_role` (`weight`, `create_time`, `update_time`, `available`, `role_id`, `rmid`)
VALUES ('41', '2019-01-14 17:28:00', '2019-01-14 17:28:00', '1', '3', '41');

INSERT INTO `k8s_auth_server`.`resource_menu_role` (`weight`, `create_time`, `update_time`, `available`, `role_id`, `rmid`)
VALUES ('41', '2019-01-14 17:28:00', '2019-01-14 17:28:00', '1', '4', '41');

INSERT INTO `k8s_auth_server`.`resource_menu_role` (`weight`, `create_time`, `update_time`, `available`, `role_id`, `rmid`)
VALUES ('41', '2019-01-14 17:28:00', '2019-01-14 17:28:00', '1', '5', '41');

INSERT INTO `k8s_auth_server`.`resource_menu_role` (`weight`, `create_time`, `update_time`, `available`, `role_id`, `rmid`)
VALUES ('41', '2019-01-14 17:28:00', '2019-01-14 17:28:00', '1', '6', '41');

INSERT INTO `k8s_auth_server`.`resource_menu_role` (`weight`, `create_time`, `update_time`, `available`, `role_id`, `rmid`)
VALUES ('41', '2019-01-14 17:28:00', '2019-01-14 17:28:00', '1', '7', '41');
...
VALUES ('k8s 审计日志', 'k8s Audit', 'menu', 'k8sAuditLog', '41', '2019-01-14 16:47:00', '2019-01-14 16:50:56', '1', '', '0', '9', 'k8sauditlog');