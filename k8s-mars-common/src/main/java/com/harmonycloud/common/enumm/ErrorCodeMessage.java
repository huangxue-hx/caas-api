...
public enum ErrorCodeMessage {
    //通用错误 1xxxxx
    UNKNOWN(100001, "Server error, please contact system manager.", "系统错误，请联系系统管理员"),
    INVALID_PARAMETER(100002, "invalid parameter.", "参数错误"),
    INVALID_CONFIG(100003, "config error.", "配置错误"),
    PARAMETER_VALUE_NOT_PROVIDE(100004, "parameter value not provide.", "参数不能为空"),
    NOT_BLANK(100005, "can not be empty.", "不能为空"),
    ...
    USER_NOT_AUTH(200002, "user not auth.","该用户未授权，请联系管理员"),
    ONLY_FOR_MANAGER(200003, "Operation only allowed for manager.","只有管理员用户可以操作"),
    USER_ROLE_DISABLED(200004, "User role is disabled .","当前用户所属角色被禁用"),
    CANNOT_OPERATE_YOURSELF(200005, "Can not operate yourself.","管理员不能操作自己账户"),
    ...
    USER_REAL_NAME_ERROR(200008, "user real name .","用户真实姓名错误"),
    ...
    USER_UPDATE_INFO_ERROR(200016, "user info being update is error.","没有需要修改的用户信息"),
    ...
    USER_NOT_LOGIN(200023, "user not login or timeout.","用户未登录或登录超时"),
    ...
    USER_NOT_AUTH_OR_TIMEOUT(200026, "User login timeout","用户未授权或登录超时"),
    ...
    SWITCH_ROLE_INCORRECT(203016, "The role is disable or the user is removed from thr role group,please contact the administrator.","角色不可用或者用户被移除该角色组，请联系管理员！"),
    ...
    ROLE_DISABLE(203024, "User roles are disabled.","当前用户角色被停用，请联系管理员!"),
    ...
    ADMIN_ROLE_CANNOT_DISABLE(203027, "You cannot disable .","不能禁用管理员!"),
    ...
    HARBOR_VERIFY_ERROR(300005, "Harbor info verify error.","验证harbor信息失败"),
    CLUSTERQUOTA_INCORRECT(300006, "Cluster quota incorrect.","修改的配额不正确"),
    ...
    NETWORK_ALREADY_BIND(300023, "network has been bound","网络已经被绑定"),
    CLUSTER_STATUS_NOT_NEED_UPDATE(300024, "cluster status is identical, not need to update","集群状态一致，不需要更新"),
    ...
    TEMPLATE_NAME_CAN_NOT_UPDATE(300028,"template name can not update","模板名字不允许更新"),
    NODE_NOT_FIND_IN_CLUSTER(300029, "Node not find in this cluster.", "集群内没有节点"),
	...
	DATACENTER_NOT_HAS_NICENAME(300035,"datacenter do not have nicename.","该数据中心没有别名"),
	DATACENTER_NICENAME_SAME(300036,"new nickname same with old nicknae.","别名一致"),
	DATACENTER_UPDATE_FAIL(300037,"datacenter update fail","该数据中心更新失败"),

    //主机节点 301xxx
    NODE_LABEL_CREATE_ERROR(301001, "Node label create failed.","节点标签创建失败"),
    NODE_LABEL_ERROR(301002, "Node label error.","节点标签错误"),
    NODENAME_NOT_BLANK(301003, "Node name can not blank.","节点名称不能为空"),
    NODE_NOT_EXIST(301004, "Node was not existed.","节点不存在"),
    NODE_EXIST(301005, "Node was existed.","节点已经存在"),
    WORK_NODE_OFFLINE(301006, "Work node can not removed.","工作节点不能下线"),
    DRAIN_IN_PROCESS(301007, "There is already a migrate progress in process.","节点应用迁移已在进行中"),
    NODE_STATUS_REQUIRE(301008, "only allow for idle or stateless node","只能修改闲置节点或者无状态节点"),
    PRIVATE_NODE_NOT_EXIST(301009, "Warn: Can not find private node for this namespace, node label has been modified",
            "警告：已经删除当前分区，但是当前分区为私有分区，所属独占节点属性被修改，导致独占节点不存在，请不要随意更改节点私有属性，以免发生冲突，如果在接下来的操作中遇到其它问题，请联系管理员!"),
    NODE_NOT_REMOVE(301010, "The node has other pods ,please delete it.","节点有其他应用pod，请删除pod后再移除"),
    NODE_POD_NONE(301011, "there is no pod on the node.","节点上没有运行pod"),
    NODE_CANNOT_REMOVED(301012, "Node can not be removed.","节点已经分配给租户不能下线，请在对应的租户配额中移除该节点后下线!"),
    NODE_CANNOT_REMOVED_FORTENANT(301013, "Node can not be removed.","节点已经分配给分区不能移除，请在对应的分区中移除该节点!"),
    NODE_LABEL_UPDATE_ERROR(301014, "Node status update failed.","节点状态更新失败"),
    NODE_UNSCHEDULABLE_ONLY(301015, "only allow for unschedulable node.","只允许操作维护状态节点"),
    NODE_STATUS_NOT_REMOVE(301016, "The node has other pods ,please drain application.","节点有其他应用pod，请应用迁移后再修改"),
    ...
    INVALID_NS_NAME(302009, "namespace name was invalid.","无效的分区名"),
    ...
    CONFIGMAP_IS_EMPTY(400042, "ConfigMap is empyt.", "配置文件内容为空"),
    ...
    PV_PROVIDER_NOT_EXIST(402005, "pv provider not provide.", "pv存储未提供"),
    ...
    //日志管理 404xxx
    QUERY_LOG_TOPOLOGY_ERROR(404001, "query fulllink topology fail.","查询全链路拓扑图失败"),
    QUERY_LOG_CONTENT_ERROR(404002, "query fulllink log content fail.","查询全链路日志内容失败"),
    ...
    PIPELINE_DEPLOY_ERROR(406026, "Pileline deploy failed.", "流水线部署失败"),
    ...
    DOCKERFILE_NOT_EXIST(406039, "Dockerfile not exist.", "Dockerfile已删除"),
    ...
    //其他9xxxxx
    FREE_TRIAL_END(900001, "free trial end.","试用已结束，请联系管理员"),
