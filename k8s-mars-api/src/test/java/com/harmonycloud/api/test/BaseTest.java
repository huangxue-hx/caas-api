...
public class BaseTest extends AbstractTransactionalTestNGSpringContextTests {
    ...
    private static final String NFS_SERVER = "yt01-nas02-sc0";
    ...
    public void initTestData() throws Exception{
        ...
        httpSession.setAttribute(CommonConstant.ROLEID,1);
    ...
    private StorageClassDto getStorageClass() throws Exception{
        ...
        configMap.put("NFS_PATH", "/tst_caas_dev00/" + devCluster.getName() + "/"+TEST_NAME);
